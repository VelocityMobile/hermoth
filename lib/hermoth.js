  ...
  async doConnect() {
    ...
    do {
      try {
        ...
        connected = false
        this.log.error(`Failed to connect to ${this.connDetails()}: ${err.code}. ${this.retryConnection ? `Retrying in ${this.connectionRetryDelay / 1000} seconds..` : ''}`) // eslint-disable-line max-len
